...
OUTPUT="$ROOT/Sources/betterimsg/Version.swift"
PLIST_OUTPUT="$ROOT/Sources/betterimsg/Resources/Info.plist"
...
<dict>
  ...
  <string>com.albertkuo.betterimsg</string>
  <key>CFBundleName</key>
  <string>betterimsg</string>
